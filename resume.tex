...
%______________________________________________________________________________________________________________________
\begin{document}
\name{\Large Simon Holmbacka. PhD -- Resume\flushright{1 August 2017}}
\begin{resume}
\begin{picture}(320,0)
...
\small{
    ...
    20900 Turku, Finland		\vspace{0mm}\\\vspace{0mm}%
...
\section{\mysidestyle Position}
    ...
    University of Turku\\
    Task: \textit{Creating MooCs for online education (25\% contract)}\\  
...
Furthermore I have experience in other object oriented programming languages, mostly C++ and Java, and I have of course stumbled upon some Java script, xml and assembly progamming.
...
I created two online education MooCs on coursera.org from scratch in the EIT Digital project in 2015, 2016 and 2017, which are now freely available on Coursera and has thousands active students.\\ 
...
\section{\mysidestyle Teaching\\Experience}
  \textbf{Course creator}: EIT Digital Online Coursera\\ \textit{Autonomous Runway Detection for IoT} \hfill \textbf{Summer 2017}\\
...
\section{\mysidestyle Invited Speeches}
